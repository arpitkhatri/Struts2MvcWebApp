        ...
        if(f)try{
            if(b(this.p.colModel).each(function(a){
                ...
                if(g.p.treeGrid)for(m in g.p.treeReader)g.p.treeReader.hasOwnProperty(m)&&
                    delete l[g.p.treeReader[m]];void 0!==n&&(g.p.data[n]=b.extend(!0,g.p.data[n],l));
                l=null
                }
            }catch(t){
            a=!1
        ...
        switch(this.stype){
            ...
            if(m){
                ...
                if("string"===typeof m){
                    ...
                    (o=document.createElement("option"),o.value=q,o.innerHTML=m[q],l.appendChild(o));void 0!==d.defaultValue&&a(l).val(d.defaultValue);
...
setGroupHeaders:function(b){
    ...
    return this.each(function(){
        ...
        var r,o=function(a,b){
            var c=b.length,d;
            for(d=0;d<c;d++)if(b[d].startColumnName===a)return d;return-1
            };
        ...
        for(c=0;c<s;c++)if(e=n[c].el,d=a(e),f=l[c],h={
            ...
            display:f.hidden?"none":"",
            "border-top":"0px none"
        }).insertBefore(d),j.append(e)):(j.append(e),g--);l=a(this).children("thead");
        l.prepend(m);
        j.insertAfter(k);
        i.append(l);
...
function u(){
    ...
    for(r in j)if(j.hasOwnProperty(r)&&(l=a.jgrid.checkValues.call(d,j[r],r),!1===l[0]))break;u();
    ...
    if(l[0]&&!b[d.p.id].processing){
        ...
        if(!0===d.p.treeGrid)for(n in j[m]===h.addoper&&(o=
            a(d).jqGrid("getGridParam","selrow"),j["adjacency"===d.p.treeGridModel?d.p.treeReader.parent_id_field:"parent_id"]=o),d.p.treeReader)d.p.treeReader.hasOwnProperty(n)&&(g=d.p.treeReader[n],j.hasOwnProperty(g)&&!(j[m]===h.addoper&&"parent_id_field"===n)&&delete j[g]);j[i]=a.jgrid.stripPref(d.p.idPrefix,j[i]);
        n=a.extend({
            ...
            if(void 0!==a("#"+a.jgrid.jqID(o.themodal))[0]){
                ...
                a("#dData","#"+g+"_2").click(function(){
                    ...
                    if(f[0]&&!b[e.p.id].processing){
                        ...
                        for(h in i)i.hasOwnProperty(h)&&(i[h]=a.jgrid.stripPref(e.p.idPrefix,i[h]));n[x]=i.join();
                    ...
                    if(!h.url&&
                        !b[e.p.id].useDataProxy)if(a.isFunction(e.p.dataProxy))b[e.p.id].useDataProxy=true;
                        else{
                        f[0]=false;
...
(function(c){
    ...
    c.jqm={
        ...
        close:function(a){
            ...
            if(a.c.onHide)a.c.onHide(a);else a.w.hide(),a.o&&a.o.remove();return d
            },
            params:{}
        };
    ...
    return a.each(function(){
        var a=this._jqm;c(i).each(function(){
            this[b]||(this[b]=[],c(this).click(function(){
                for(var a in{
                    jqmShow:1,
            jqmHide:1
                    })for(var b in this[a])if(j[this[a][b]])j[this[a][b]].w[a](this);return d
                }));this[b].push(a)
            })
        })
    }
    ...
    var c=b.jqDnR,d=c.dnr,e=c.e,g,f,h=function(a,
        c,h,l){
    return a.each(function(){
        c=c?b(c,a):a;c.bind("mousedown",{
            e:a,
    k:h
            },function(a){
            var c=a.data,i={};
            e=c.e;g=l?b(l):!1;if("relative"!=e.css("position"))try{
            e.position(i)
            }
            catch(h){}
            d={
    ...
    pY:a.pageY,
    k:c.k
            }:!1;if(b("input.hasDatepicker",
                e[0])[0])try{
            b("input.hasDatepicker",e[0]).datepicker("hide")
            }catch(m){}
            b(document).mousemove(b.jqDnR.drag).mouseup(b.jqDnR.stop);return!1
            })
        })
    },j=function(a){
...
(function(b){
    b.jgrid.extend({
        setSubGrid:function(){
        return this.each(function(){
            var e,c;this.p.subGridOptions=b.extend({
    ...
    fixed:!0
            ...
            e=this.p.subGridModel;if(e[0]){
            e[0].align=b.extend([],e[0].align||[]);for(c=0;c<e[0].name.length;c++)e[0].align[c]=e[0].align[c]||"left"
            }
        })
    },
    addSubGridCell:function(b,c){
    var a="",m,l;this.each(function(){
        a=this.formatCol(b,c);l=this.p.id;m=this.p.subGridOptions.plusicon
    ...
    return this.each(function(){
        ...
        e=b("<td align='"+a.p.subGridModel[0].align[h]+"'></td>").html(e);b(c).append(e)
        },l=function(c,e){
        var h,f,n,d=b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),i=b("<tr></tr>");for(f=0;f<a.p.subGridModel[0].name.length;f++)h=b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"+a.p.direction+"'></th>"),b(h).html(a.p.subGridModel[0].name[f]),b(h).width(a.p.subGridModel[0].width[f]),b(i).append(h);b(d).append(i);c&&(n=a.p.xmlReader.subgrid,
            b(n.root+" "+n.row,c).each(function(){
                i=b("<tr class='ui-widget-content ui-subtblcell'></tr>");if(!0===n.repeatitems)b(n.cell,this).each(function(a){
                    m(i,b(this).text()||"&#160;",a)
                    });else{
        ...
        setTreeGrid:function(){
            return this.each(function(){
                ...
                if(b.p.treeGrid){
                    ...
                    for(e in b.p.colModel)if(b.p.colModel.hasOwnProperty(e))for(i in h=b.p.colModel[e].name,h===b.p.ExpandColumn&&!a&&(a=!0,b.p.expColInd=c),c++,b.p.treeReader)b.p.treeReader.hasOwnProperty(i)&&b.p.treeReader[i]===h&&g.push(h);d.each(b.p.treeReader,function(a,e){
    ...
    return this.each(function(){
        ...
        if(this.grid&&this.p.treeGrid&&(a=this.p._index[b],void 0!==a)){
            ...
            if("nested"===this.p.treeGridModel){
                ...
                if(c.length)for(f in c)c.hasOwnProperty(f)&&(c[f][h]=parseInt(c[f][h],10)-g);c=d.jgrid.from(this.p.data).greater(e,
                    i,{
                        stype:"integer"
                    }).select();
    ...
    if(a){
        ...
        if("nested"===e.p.treeGridModel){
            ...
            if(null!==c){
                ...
                if(f.length)for(o in f)f.hasOwnProperty(o)&&(f[o][k]=parseInt(f[o][k],10)+2);f=d.jgrid.from(e.p.data).greater(m,g,{
                    stype:"integer"
                }).select();
                if(f.length)for(o in f)f.hasOwnProperty(o)&&(f[o][m]=parseInt(f[o][m],10)+2);a[k]=g+1;
                a[m]=g+2
                }
            }
...
jqGridExport:function(a){
    ...
    this.each(function(){
        if(this.grid){
            ...
            b.knv=null;
            if(b.treeGrid)for(f in b.treeReader)b.treeReader.hasOwnProperty(f)&&(b.colNames.splice(b.colNames.length-1),b.colModel.splice(b.colModel.length-1));switch(a.exptype){
                case "xmlstring":
                    d=
