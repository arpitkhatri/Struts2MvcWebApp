...
//    },
                    colNames: ['Platform Id', 'Platform Code', 'Platform DSC', 'Active Status', 'Effective Start Date', 'Effective End Date', 'Create Date', 'Updated Date'],
                    colModel: [
                        {name: 'platformID', index: 'platformID', editable: true, hidden: true},
                        {name: 'platformCode', index: 'platformCode', editable: true,editrules:{required:true},editoptions:{readonly:true},
                              formoptions:{
                                elmprefix:"<span class='mystar' style='color:red'>*</span>&nbsp;"
                            }},
                        {name: 'platformDsc', index: 'platformDsc', editable: true,editrules:{required:true},
                             formoptions:{
                                elmprefix:"<span class='mystar' style='color:red'>*</span>&nbsp;"
                            }},
                        ...
                        {name: 'updateDate', index: 'updateDate', editable: true, editrules: {edithidden: true},
                            editoptions: {size: 20,
                                readonly: true,
                                dataInit: function(el) {
                                    $(el).datepicker({
...
//                        $("#cb_"+myGrid[0].id).hide();
                        ...
                        roleBasedNavOption,
                {
                    ...
                    onclickSubmit: function(params) {
                        params.url = 'updatePlatformDetails?platformId=' + $('#platformID').val()+'&platformCode'+ $('#platformCode').val()+'&platformDsc'+ $('#platformDsc').val()+'&activeStatus'+ $('#activeStatus').val()+'&effStartDate'+ $('#effStartDate').val()+'&effEndDate'+$('#effEndDate').val()+'&createDate'+$('#createDate').val()+'&updateDate'+$('#updateDate').val();
                        params.mtype = 'POST';
                    },
                    recreateForm: true,
                    ...
                    afterSubmit: function(data, postdata) {
                        ...
                        if (result.successEdit != "") {
                            ...
                            return[false, "Platfrom Details Already Exists !!"];
                        }
                    }
                }, //end of edit
                {
                    ...
                    reloadAfterSubmit: true,
                    onclickSubmit: function(params) {
                       params.url = 'addPlatformDetails?platformId=' + $('#platformID').val()+'&platformCode'+ $('#platformCode').val()+'&platformDsc'+ $('#platformDsc').val()+'&activeStatus'+ $('#activeStatus').val()+'&effStartDate'+ $('#effStartDate').val()+'&effEndDate'+$('#effEndDate').val()+'&createDate'+$('#createDate').val()+'&updateDate'+$('#updateDate').val();
                        params.mtype = 'POST';
                    },
                    recreateForm: true,
                    viewPagerButtons: false,
                    beforeShowForm: function(e) {
                          $('#platformCode').removeAttr('readonly');
                        var form = $(e[0]);
                        form.closest('.ui-jqdialog').find('.ui-jqdialog-titlebar').wrapInner('<div class="widget-header" />')
                        style_edit_form(form);
                    },
                    afterSubmit: function(data, postdata) {
                        ...
                        if (result.successAdd != "") {
                            ...
                            return[false, "Platform Detail Already Exists !!"];
                        }
                    }
                },
                {
                    ...
                    onclickSubmit: function(params) {
                        ...
                        var cellValue = $(grid_selector).jqGrid('getCell', selectedRowId, 'platformID');
                        params.url = 'deletePlatformById';
                        params.mtype = 'POST';
                        return {platformID: cellValue};
                    },
                    afterSubmit: function(data, postdata) {
                        var result = jQuery.parseJSON(data.responseText);
