...
//    },
                    colNames: ['ID', 'First Name', 'Last Name', 'User Id', 'Password', 'User Role', 'Modified Date'],
                    colModel: [
                        ...
                        {name: 'LastName', index: 'LastName', editable: true,editrules:{required:true},
                         ...
                         {name: 'UserID', index: 'UserID', editable: true,editrules:{required:true},
                             formoptions:{
                                elmprefix:"<span class='mystar' style='color:red'>*</span>&nbsp;"
                            }},
                         ...
                         {name:'UserRole',index:'UserRole', width:150,editable: true,editoptions:{size:"20",maxlength:"45"},editrules:{required:true},
                            formoptions: {
                                elmprefix:"<span class='mystar' style='color:red'>*</span>&nbsp;"
                            }, edittype:"select",
                            editoptions:{
                                dataUrl:'getUserRoles'
                            }
                            ,editrules:{required:true,custom:true,custom_func:checkRole}
                        },
                        {name: 'ModifiedDate', index: 'ModifiedDate', editable: true, editrules: {edithidden: true},
                            editoptions: {size: 20,
                                readonly: true,
...
//                        $("#cb_"+myGrid[0].id).hide();
                        ...
                        roleBasedNavOption,
                {
                    ...
                    onclickSubmit: function(params) {
                        params.url = 'updateUserDetails?FirstName=' + $('#FirstName').val()+'&LastName'+ $('#LastName').val()+'&UserID'+ $('#UserID').val()+'&PassWord'+ $('#PassWord').val()+'&UserRole'+ $('#UserRole').val()+'&ModifiedDate'+$('#ModifiedDate').val();
                        params.mtype = 'POST';
                    },
                    recreateForm: true,
                ...
                }, //end of edit
                {
                    ...
                    reloadAfterSubmit: true,
                    onclickSubmit: function(params) {
                       params.url = 'addUserDetails?FirstName=' + $('#FirstName').val()+'&LastName'+ $('#LastName').val()+'&UserID'+ $('#UserID').val()+'&PassWord'+ $('#PassWord').val()+'&UserRole'+ $('#UserRole').val()+'&ModifiedDate'+$('#ModifiedDate').val();
                        params.mtype = 'POST';
                    },
                    recreateForm: true,
                ...
                },
                {
                    ...
                    onclickSubmit: function(params) {
                        ...
                        var cellValue = $(grid_selector).jqGrid('getCell', selectedRowId, 'ID');
                        params.url = 'deleteUserDetailById';
                        params.mtype = 'POST';
                        return {ID: cellValue};
                    },
                    afterSubmit: function(data, postdata) {
